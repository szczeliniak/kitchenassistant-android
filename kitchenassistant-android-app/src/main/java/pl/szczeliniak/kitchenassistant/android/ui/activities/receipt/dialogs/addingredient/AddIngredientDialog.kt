...
class AddIngredientDialog private constructor() : DialogFragment() {
    ...
    companion object {
        ...
        val UNITS = IngredientUnit.values().map { it.name }
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        binding.dialogAddIngredientSpinnerUnit.adapter =
            ArrayAdapter(requireContext(), R.layout.support_simple_spinner_dropdown_item, UNITS)
    ...
    override fun onResume() {
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener {
            ...
            viewModel.addIngredient(receiptId, AddIngredientRequest(name, quantity, unit))
    ...
    private val unit: IngredientUnit
        get() {
            return IngredientUnit.valueOf(binding.dialogAddIngredientSpinnerUnit.selectedItem as String)
        }

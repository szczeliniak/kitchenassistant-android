...
import pl.szczeliniak.kitchenassistant.android.databinding.DialogChooseDayPlanForRecipeBinding
...
@AndroidEntryPoint
class ChooseDayPlanForRecipeDialog : DialogFragment() {

    companion object {
        private const val ON_DAY_PLAN_CHOSEN_CALLBACK_EXTRA: String = "ON_DAY_PLAN_CHOSEN_CALLBACK_EXTRA"
        private const val RECIPE_ID_EXTRA: String = "RECIPE_ID_EXTRA"
        private const val TAG = "ChooseDayPlanForRecipeDialog"

        fun show(fragmentManager: FragmentManager, recipeId: Int, onDayPlanChosen: OnDayPlanChosen) {
            val dialog = ChooseDayPlanForRecipeDialog()
            val bundle = Bundle()
    ...
    private lateinit var binding: DialogChooseDayPlanForRecipeBinding
    ...
    private val viewModel: ChooseDayPlanForRecipeDialogViewModel by viewModels()

    private var selectedDayPlanId: Int? = null

    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        binding = DialogChooseDayPlanForRecipeBinding.inflate(layoutInflater)
    ...
    override fun onResume() {
        ...
        button.setOnClickListener {
            selectedDayPlanId?.let { onDayPlanChosen.onDayPlanChosen(it, recipeId) }
            dismiss()
        }
    ...
    @Parcelize
    class OnDayPlanChosen(private val action: (dayPlanId: Int, recipeId: Int) -> Unit) : Parcelable {
        fun onDayPlanChosen(dayPlanId: Int, recipeId: Int) = action(dayPlanId, recipeId)
    }
